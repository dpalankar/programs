...
//        1) Given a list of integers, separate odd and even numbers
        ...
        numbers.stream().collect(Collectors.partitioningBy(i -> i % 2 == 0)).forEach((k, v)-> {
//            System.out.println(k);
            String s= k ?"EVEN":"ODD "; System.out.println(s+" : "+v);
        });
...
//        6) Given a list of strings, join the strings with ‘[‘ as prefix, ‘]’ as suffix and ‘,’ as delimiter?
        List<String> listOfSM = Arrays.asList("Facebook", "Twitter", "YouTube", "WhatsApp", "LinkedIn");
        System.out.println("Joined String :"+listOfSM.stream().collect(Collectors.joining(",","[","]")));
...
//        8) Given a list of integers, find maximum and minimum of those numbers?
        ...
        System.out.println("Max :"+listOfIntegers2.stream().max(Comparator.naturalOrder()));
        System.out.println("Min :"+listOfIntegers2.stream().min(Comparator.naturalOrder()));
...
//        10) How do you merge two unsorted arrays into single sorted array without duplicates?
        ...
        int[] d = IntStream.concat(Arrays.stream(a1), Arrays.stream(b1)).distinct().sorted().toArray();
